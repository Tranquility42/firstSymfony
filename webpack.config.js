...
Encore
    ...
    .addStyleEntry('style', './assets/front/styles/index.scss')
    .addEntry('script', './assets/front/scripts/script.js')
    .addEntry('script_home', './assets/front/scripts/script_home.js')
